        ...
        return [
            {
                ...
                "status": r.status,
                "consumed_at": None if r.consumed_at is None else r.consumed_at.isoformat(),
            }
            for r in records
        ]
        ...
        *,
        ...
        async with self._session_factory() as session:
            ...
            if update_result.rowcount != 1:
                ...
                return None
            await session.commit()
            # Reload for response (decided_by/reason recorded via admin audit until schema expands)
            _ = decided_by, reason
            ...
            return {
                ...
                else record.consumed_at.isoformat(),
